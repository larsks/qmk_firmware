...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT(
        ...
        _______, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, KC_MS_BTN3, _______, _______, _______, _______, _______, _______, _______, _______, _______,   KC_MS_BTN1, KC_MS_BTN2, KC_MS_BTN3, \
